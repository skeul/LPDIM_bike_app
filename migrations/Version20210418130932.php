 ...
 */
final class Version20210418130932 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE parcours ADD COLUMN name VARCHAR(255) NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('INSERT INTO electric (id, puissance, autonomie) SELECT id, puissance, autonomie FROM __temp__electric');
        $this->addSql('DROP TABLE __temp__electric');
        $this->addSql('CREATE TEMPORARY TABLE __temp__parcours AS SELECT id, distance, difficulte FROM parcours');
        ...
        $this->addSql('INSERT INTO parcours (id, distance, difficulte) SELECT id, distance, difficulte FROM __temp__parcours');
