 ...
 */
final class Version20210418131151 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__sortie AS SELECT id, parcours_id, date_sortie, status FROM sortie');
        $this->addSql('DROP TABLE sortie');
        $this->addSql('CREATE TABLE sortie (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, parcours_id INTEGER NOT NULL, date_sortie DATETIME NOT NULL, status INTEGER NOT NULL, nom VARCHAR(255) NOT NULL, CONSTRAINT FK_3C3FD3F26E38C0DB FOREIGN KEY (parcours_id) REFERENCES parcours (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO sortie (id, parcours_id, date_sortie, status) SELECT id, parcours_id, date_sortie, status FROM __temp__sortie');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__sortie AS SELECT id, parcours_id, date_sortie, status FROM sortie');
        $this->addSql('DROP TABLE sortie');
        $this->addSql('CREATE TABLE sortie (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, parcours_id INTEGER NOT NULL, date_sortie DATETIME NOT NULL, status INTEGER NOT NULL)');
        $this->addSql('INSERT INTO sortie (id, parcours_id, date_sortie, status) SELECT id, parcours_id, date_sortie, status FROM __temp__sortie');
        $this->addSql('DROP TABLE __temp__sortie');
        $this->addSql('CREATE INDEX IDX_3C3FD3F26E38C0DB ON sortie (parcours_id)');
        $this->addSql('DROP INDEX IDX_8A67684ACC72D953');
