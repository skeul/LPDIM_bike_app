 ...
 */
final class Version20210425115517 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('DROP INDEX IDX_EF17CAE66E38C0DB');
        $this->addSql('DROP INDEX IDX_EF17CAE65468BBDC');
        $this->addSql('CREATE TEMPORARY TABLE __temp__parcours_sommet AS SELECT parcours_id, sommet_id FROM parcours_sommet');
        $this->addSql('DROP TABLE parcours_sommet');
        $this->addSql('CREATE TABLE parcours_sommet (parcours_id INTEGER NOT NULL, sommet_id INTEGER NOT NULL, PRIMARY KEY(parcours_id, sommet_id), CONSTRAINT FK_EF17CAE66E38C0DB FOREIGN KEY (parcours_id) REFERENCES parcours (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_EF17CAE65468BBDC FOREIGN KEY (sommet_id) REFERENCES sommet (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO parcours_sommet (parcours_id, sommet_id) SELECT parcours_id, sommet_id FROM __temp__parcours_sommet');
        $this->addSql('DROP TABLE __temp__parcours_sommet');
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__sortie AS SELECT id, parcours_id, date_sortie, status, nom FROM sortie');
        $this->addSql('DROP TABLE sortie');
        $this->addSql('CREATE TABLE sortie (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, parcours_id INTEGER NOT NULL, date_sortie DATETIME NOT NULL, status INTEGER NOT NULL, nom VARCHAR(255) NOT NULL COLLATE BINARY, CONSTRAINT FK_3C3FD3F26E38C0DB FOREIGN KEY (parcours_id) REFERENCES parcours (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO sortie (id, parcours_id, date_sortie, status, nom) SELECT id, parcours_id, date_sortie, status, nom FROM __temp__sortie');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__sortie AS SELECT id, parcours_id, date_sortie, status, nom FROM sortie');
        $this->addSql('DROP TABLE sortie');
        $this->addSql('CREATE TABLE sortie (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, parcours_id INTEGER NOT NULL, date_sortie DATETIME NOT NULL, status INTEGER NOT NULL, nom VARCHAR(255) NOT NULL)');
        $this->addSql('INSERT INTO sortie (id, parcours_id, date_sortie, status, nom) SELECT id, parcours_id, date_sortie, status, nom FROM __temp__sortie');
        $this->addSql('DROP TABLE __temp__sortie');
        $this->addSql('CREATE INDEX IDX_3C3FD3F26E38C0DB ON sortie (parcours_id)');
        $this->addSql('DROP INDEX IDX_8A67684ACC72D953');
